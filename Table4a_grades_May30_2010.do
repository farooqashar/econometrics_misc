...
// In full controls and not in strata controls ==> included merely to increase precision
//strata controls (gender, year in school, and high school grade quartile)

// local fullcontrols "`stratacontrols'" 
