...
cd "/Users/asharfarooq/Downloads/Data"

cap log using NHIS2009_hicompare.log, text replace

use NHIS2009_clean, clear

cap log using NHIS2009_hicomparePARTB2C.log, text replace
...
// doing a t test based on employed graduates for group who has some health insurance and one that does not
ttest emplGraduate, by (hi)

translate NHIS2009_hicomparePARTB2C.log NHIS2009_hicomparePARTB2C.pdf
